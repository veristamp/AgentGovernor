...
export class RegistrySearchTool {
	...
	public getDefinition() {
		return {
			...
			description:
				"Search for relevant tools using natural language queries. Use this when you need tools that are not currently in your context.",
			input_schema: {
				type: "object",
				properties: {
					query: {
						type: "string",
						description:
							'Natural language query describing the capabilities you need (e.g. "search documentation", "edit files")',
					},
				},
				required: ["query"],
			},
